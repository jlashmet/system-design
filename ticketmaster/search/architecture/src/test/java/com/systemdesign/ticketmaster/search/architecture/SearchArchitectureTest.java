package com.systemdesign.ticketmaster.search.architecture;
...
@AnalyzeClasses(packages = "com.systemdesign.ticketmaster.search")
class SearchArchitectureTest {
    ...
    static final ArchRule bounded_context_does_not_depend_on_other_contexts = noClasses()
            .that().resideInAPackage("com.systemdesign.ticketmaster.search..")
            .should().dependOnClassesThat().resideInAnyPackage(
                    "com.systemdesign.ticketmaster.booking..", "com.systemdesign.ticketmaster.events..");
}
