...
public final class BookingExceptionHandler {
    ...
    ResponseEntity<ProblemDetail> checkoutExpired(CheckoutExpiredException exception) {
        ProblemDetail detail = ProblemDetail.forStatusAndDetail(HttpStatus.CONFLICT, exception.getMessage());
        detail.setTitle("Checkout expired");
    ...
    @ExceptionHandler({BookingStorageUnavailableException.class,
            AdmissionStorageUnavailableException.class,
            ReservationStorageUnavailableException.class})
